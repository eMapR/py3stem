...
MODIS_COLLECTION = "users/emaperlab/ben/elev_masks"
...
SCRIPT_TEMPLATE = './ee-ak-download-template-multi-year-modis-mask.txt'
...
def main(lt_run_info, out_dir, script_template=None):
    ...
    for i, info in lt_runs.iterrows():
        ...
        format_dict['modis_collection'] = MODIS_COLLECTION
