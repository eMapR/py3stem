...
def main(sleep=.5, njobs=10, silent=True):
    ...
    tasks = []
    if 'downloadDir' in globals():
        #ltee.listenAndDownladTasks(tasks, downloadDir, gDriveFolder, gDrive, outDir=outDir, clipFile=clipFile, silent=False, timestamp_offset=timestamp_offset)#'''
        ltee.listenAndDownladTasks(tasks, downloadDir, gDriveFolder, gDrive, silent=False, timestamp_offset=timestamp_offset, logFile=logFile)#'''
